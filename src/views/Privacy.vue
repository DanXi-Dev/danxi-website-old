...
<div align=center>
<a href="https://en.wikipedia.org/wiki/Warrant_canary"><img src="icon/canary.png" alt="这个图标意味着我们最近没有收到任何来自外部的数据披露请求，也不曾传递、发布、解密、查看任何用户储存在我们树洞服务器上的加密身份信息。如果这样的事发生了，我们会移除它。"></a>
</div>
        `
    const article = computed(() => {
      return marked(privacy)
    })
